...
matplot(virological$pos.by.strain$H3[,1:5], type='l', col=1)
matplot(virological$pos.by.strain$H1[,1:5], type='l', add=TRUE, col=2)
matplot(virological$pos.by.strain$B[,1:5], type='l', add=TRUE, col=3)
...
colnames(polymod)=c('V1','V2','V3','V4','V5','V6','V7','V8','V9','V10','V11','V12')
  ...
  vstrategy<<-dget(file='/Users/Natasha/Dropbox/UKfluworkGIT/cluster/FUNC_cov_strategy.R')  
  ...
  ########################################################################################
season.choice<-dget('FUNC_seas_post.R')
